...
def display_frame(q):
    ...
    while True:
        if not q.empty():
            ...
            depth_msg = NCB.cv2_to_imgmsg(cv_depth, "mono16")   # CV_16UC1, 16-bit grayscale image  ##http://wiki.ros.org/cv_bridge/Tutorials/UsingCvBridgeToConvertBetweenROSImagesAndOpenCVImages
